...
- Every page has: deferred GA4 loader + preconnect (first after <head>), meta author "Basho Parks", meta date "2026-05-01"
...
- stat-card headings use <h2> (Session 51, changed from h4 for WCAG heading order). CSS: .stat-card h2
